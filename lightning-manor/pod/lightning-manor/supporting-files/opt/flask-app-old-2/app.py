...
messages = [
    "What's that sound. Do you really think you can leave this place?",
    ...
    "WE SEE YOU, AND WE ARE COMING TO CLAIM YOUR SOUL"
]
...
def gate_check():
    ...
    if gate_code == 'true':
        ...
        failcount+=1
        return jsonify({'valid': False, 'message': spooky_message(failcount)})
